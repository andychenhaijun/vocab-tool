...
# (str) Package name
package.name = vocabtool

# (str) Package domain (needed for android/ios packaging)
package.domain = org.kileykam
...
requirements = python3==3.11.9, hostpython3==3.11.9, kivy, certifi, chardet, filetype, idna, requests, six, urllib3
...
android.add_assets = assets/fonts/DroidSansFallback.ttf
...
#       [app]
#       source.include_exts = py,png,jpg,ttf,atlas,kv
#       #                     ^ This is a list.
#
